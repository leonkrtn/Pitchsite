    ...
    <span className="relative inline-block">
      <span
        ...
        style={{
          ...
          color: 'transparent',
          animation: 'sparkle-sweep 2.8s linear infinite',
        }}
      >
        {children}
      </span>
      ...
      <span
        ...
        style={{ top: '-0.55em', right: '-0.25em', animation: 'sparkle-pop 2.4s ease-in-out infinite', animationDelay: '0s' }}
      >
        <Star size={7} />
      </span>
      <span
        className="absolute text-blue-200 pointer-events-none"
        style={{ top: '0.05em', left: '0.05em', animation: 'sparkle-pop 2.4s ease-in-out infinite', animationDelay: '0.85s' }}
      >
        <Star size={5} />
      </span>
      <span
        className="absolute text-blue-400 pointer-events-none"
        style={{ bottom: '-0.35em', right: '0.2em', animation: 'sparkle-pop 2.4s ease-in-out infinite', animationDelay: '1.6s' }}
      >
        <Star size={5} />
      </span>
    </span>
