...
const icons = [
  // Feedback — cursor with comment bubble
  (
  ...
  // Vertrag — document with signature line
  (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10" aria-hidden="true">
            ...
            <ScrollReveal key={i} delay={i * 0.1}>
              ...
              >
                <div>
                  ...
                  <h3 className="font-display font-bold text-xl sm:text-2xl text-ink mb-3 leading-snug">
                    {item.title}
                  </h3>
                ...
                <div className="h-px md:h-full bg-gray-100 md:bg-transparent" />
              </div>
            </ScrollReveal>
          ))}
        </div>
